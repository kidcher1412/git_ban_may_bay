...
class Player(Plane):
    ...
    def _fire(self):
        if self._power == 0:
            ...
            self._laser_size = (25, 25)
            self._fire_delay_factor = 20
        elif self._power == 1:
            self._laser_damage = 1.5
            self._laser_size = (29, 29)
            self._fire_delay_factor = 18
        elif self._power == 2:
            self._laser_damage = 2
            self._laser_size = (30, 30)
            self._fire_delay_factor = 16
